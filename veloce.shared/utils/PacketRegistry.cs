...
/// <summary>
/// A utility class for registering packet types with protobuf, ensuring compatibility for serialization and deserialization.
/// </summary>
public static class PacketRegistry
{
    ...
    private static void RegisterPackets(HierarchyNode node)
    {
        node.Children.ForEach(children => {
            ...
            children.ConcreteList.ForEach(y => {
                RegisterPacketType(children.Type, y);
            });
